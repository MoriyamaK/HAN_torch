...
argparser.add_argument("--tweet_dir", type=str,default='data/CMIN-US/news/preprocessed/')
...
argparser.add_argument('--train_x_path', type=str, default='dataset/yiyanghkust/CMIN_large/train_x.csv')
argparser.add_argument('--train_y_path', type=str, default='dataset/yiyanghkust/CMIN_large/train_y.csv')
argparser.add_argument('--dev_x_path', type=str, default='dataset/yiyanghkust/CMIN_large/dev_x.csv')
argparser.add_argument('--dev_y_path', type=str, default='dataset/yiyanghkust/CMIN_large/dev_y.csv')
argparser.add_argument('--test_x_path', type=str, default='dataset/yiyanghkust/CMIN_large/test_x.csv')
argparser.add_argument('--test_y_path', type=str, default='dataset/yiyanghkust/CMIN_large/test_y.csv')
